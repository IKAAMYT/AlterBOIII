...
DataSources.BoiiiQuickSettings = DataSourceHelpers.ListSetup("BoiiiQuickSettings", function(controller)
  ...
  table.insert(
    ...
    CoD.OptionsUtility.CreateDvarSettings(
      controller,
      "VSync",
      "Synchronise le framerate au taux de rafraîchissement.",
      "QuickSettings_vsync",
      "r_vsync",
      {
        {
  ...
  table.insert(
    ...
    CoD.OptionsUtility.CreateDvarSettings(
      ...
      "Affiche les images par seconde à l'écran.",
  ...
  table.insert(
    ...
    CoD.OptionsUtility.CreateDvarSettings(
      controller,
      "Difficulté des bots",
      "Définit le niveau de difficulté des bots.",
  ...
  if Engine.CurrentSessionMode() == Enum.eModes.MODE_MULTIPLAYER then
    ...
    table.insert(
      ...
      CoD.OptionsUtility.CreateDvarSettings(
        controller,
        "Joueurs max",
        "Nombre maximum de joueurs en partie perso.",
  ...
  table.insert(
    ...
    CoD.OptionsUtility.CreateDvarSettings(
      controller,
      "Joueurs min pour démarrer",
      "Joueurs minimum requis pour lancer une partie.",
...
LUI.createMenu.BoiiiQuickSettingsMenu = function(controller)
  ...
  GameSettingsBackground.MenuFrame.titleLabel:setText(Engine.Localize("RÉGLAGES RAPIDES"))
  GameSettingsBackground.MenuFrame.cac3dTitleIntermediary0.FE3dTitleContainer0.MenuTitle.TextBox1.Label0:setText(
    Engine.Localize("RÉGLAGES RAPIDES")
  )
  ...
  Options.Title.DescTitle:setText(Engine.Localize("Réglages fréquents"))
